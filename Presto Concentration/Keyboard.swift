...
func lowestPitchForLetter(pitchLetter:PitchLetter) -> Pitch{
    switch(pitchLetter){
    case PitchLetter.A:
...
class Keyboard:NSObject{
    static func isIvory(pitch:Pitch) -> Bool{
        let isIvory:Bool
    ...
    static func letterIfIvory(possibleIvoryPitch:Pitch) -> PitchLetter?{
